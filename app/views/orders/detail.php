                                ...
                                <?php foreach ($orderDetails as $item): ?>
                                    <tr class="border-bottom">
                                        <td class="p-3" style="width: 90px;">
                                            <img src="/mystore/public/images/products/<?php echo htmlspecialchars($item['product_image']); ?>" 
                                                 alt="<?php echo htmlspecialchars($item['product_name']); ?>" 
                                                 class="img-fluid rounded border">
                                        </td>
                                        <td class="p-3">
                                            <a href="/mystore/product?id=<?php echo htmlspecialchars($item['productId']); ?>" 
                                               class="text-dark fw-bold text-decoration-none d-block mb-1">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center px-0 fw-bold h5 mt-3">
                            ...
                            <span class="text-danger">
                                <?php echo number_format($orderSummary['totalAmount'], 0, ',', '.'); ?>đ
                            </span>
                        </li>
                    </ul>
                </div>
